      ...
      >
        {isLoading ? (
          <svg className="animate-spin h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.373A8 8 0 0112 4.001v4c-.345 0-.688.03-1.024.087m14.462 3.839a8 8 0 01-7.281 7.281c.056-.336.086-.679.086-1.024h4c0 1.127-.22 2.209-.62 3.214m-14.91-.476c-.464.544-.972 1.053-1.514 1.517a8 8 0 017.28-7.281c-.464.544-.972 1.053-1.514 1.517"></path>
          </svg>
        ) : null}
        {props.children}
      </Comp>
